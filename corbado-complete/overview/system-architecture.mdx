...
{/* We use absolute links (https://docs.corbado.com/...) instead of relative links
     because the broken-links CI from mint incorrectly flags relative links in the card component as broken. */}
<Card href="https://docs.corbado.com/api-reference/frontend-api">
...
{/* We use absolute links (https://docs.corbado.com/...) instead of relative links (/...) 
     because the broken-links CI from mint incorrectly flags relative links in the card component as broken. */}
<Card href="https://docs.corbado.com/api-reference/backend-api">
