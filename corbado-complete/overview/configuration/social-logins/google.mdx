...
## Preliminary Steps
- Create a Corbado project via the [Corbado developer panel](https://app.corbado.com/signin#register). More details are available in [Getting Started](/corbado-complete/overview/getting-started).
...
1. In the [Corbado developer panel](https://app.corbado.com), navigate to **[Settings > User Interface > Social](https://app.corbado.com/settings/userinterface?tab=Social)**.
Activate the Google option and ensure "Use custom credentials" is selected. Copy the Authorized Redirect URI for later use.

![Developer Panel Google](/images/overview/configuration/social-logins/google/dev-panel-google.webp)
...
![Google Cloud Credentials](/images/overview/configuration/social-logins/google/google-cloud-credentials.webp)

3. Create an OAuth client ID in the Google Cloud console. Once created, copy the Client ID and Client Secret.

![Google Cloud 0Auth-Client](/images/overview/configuration/social-logins/google/google-cloud-0auth-client.webp)

4. Return to the Corbado developer panel, and in the modal window, paste the Client ID and Client Secret you just obtained.

![Developer Panel Google Filled](/images/overview/configuration/social-logins/google/dev-panel-google-filled.webp)
