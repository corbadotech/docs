...
<CardGroup>
  <Card href="./write">Write `Authorization` header</Card>
  <Card href="./read">Read `Authorization` header</Card>
</CardGroup>
...
<CardGroup>
  <Card href="./authorization-header/write">Write `Authorization` header</Card>
  <Card href="./authorization-header/read">Read `Authorization` header</Card>
</CardGroup>
