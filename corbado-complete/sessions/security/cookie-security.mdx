...
On successful authentication, the Corbado [Frontend API](/overview/corbado-api-structure/frontend-api) sets the following cookies:
...
| **Long-term** session  | cbo_long_session  | Session ID (opaque string) | [Frontend API](/overview/corbado-api-structure/frontend-api) | `httpOnly` `secure` `sameSite=lax` | 1 day            |
