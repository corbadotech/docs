...
| **refresh-token**      | cbo_refresh_token | Opaque string              | [Frontend API](/corbado-complete/overview/corbado-api-structure/frontend-api) | `httpOnly` `secure` `sameSite=lax` | 1 day            |
