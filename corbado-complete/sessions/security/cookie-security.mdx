...
| **refresh-token**      | cbo_long_session  | Session ID (opaque string) | [Frontend API](/corbado-complete/overview/corbado-api-structure/frontend-api) | `httpOnly` `secure` `sameSite=lax` | 1 day            |
