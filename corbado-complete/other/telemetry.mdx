...
|-------|------|----------|---------|-------------|
| `projectId` | `String` | Yes | - | Your Corbado project ID |
| `debugMode` | `bool?` | No | `false` | Enables our doctor tool to help debug and troubleshoot your passkey integration |
| `telemetryDisabled` | `bool?` | No | `false` | Disables telemetry data collection |
| `telemetryDebugModeEnabled` | `bool?` | No | `false` | Prints telemetry events to console instead of sending them |