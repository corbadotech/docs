...
This event is triggered once when a Corbado component is mounted in your application, helping us understand the development environment and which features are most used and which need improvement.
</Accordion>
