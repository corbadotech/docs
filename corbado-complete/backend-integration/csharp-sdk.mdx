...
<NoSdkSupportIntro language="C#/.NET" />
...
Since there is no official Corbado C#/.NET SDK, you need to validate session tokens (JWTs) manually in your backend. This ensures that only valid, untampered tokens are accepted for authentication. We recommend using a JWT library such as [System.IdentityModel.Tokens.Jwt](https://www.nuget.org/packages/System.IdentityModel.Tokens.Jwt/).
...
## How to manually validate a Corbado session token (JWT) in C#
...
<NoSdkOpenapiClientGeneration language="C#/.NET" />

---

# Session handling

<NoSdkSessionHandling language="C#/.NET" />
