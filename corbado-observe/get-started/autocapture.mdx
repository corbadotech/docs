...
<Note>
  If you integrate from your own source code, the [Observe data layer](/corbado-observe/get-started/data-layer) gives you the same central mapping fed by a few events your app pushes. [Custom events](/corbado-observe/get-started/custom-events) remain available as hand-written tracker calls and take 1 to 3 days for a typical login flow.
</Note>
