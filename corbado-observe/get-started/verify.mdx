...
| **[Observe CLI](/corbado-observe/tools/cli)** *(beta)* | The same checks from the terminal: `events-feed` for arrivals, `classify` to classify now, `classification-errors` for why a session did not classify, `session` for the classified journey. |
