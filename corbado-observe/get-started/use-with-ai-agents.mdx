...
4. **Verifies** by walking each journey with debug mode on and confirming events fire as expected — see the [Precision tracking](/corbado-observe/get-started/precision-tracking) verify step.

## 4. See also

- [Precision tracking](/corbado-observe/get-started/precision-tracking) — install the SDK and send your first event manually.
