...
| iOS (Swift) | No | No | Yes | Native SDK. Autocapture and the data layer are browser techniques with no native equivalent. |
| Android (Kotlin) | No | No | Yes | Native SDK, `com.corbado:observe`, minSdk 23. |
...
<CardGroup cols={2}>
  <Card title="Integration paths" icon="route" href="/corbado-observe/overview/integration-paths">
    Autocapture, data layer or custom events.
  </Card>
