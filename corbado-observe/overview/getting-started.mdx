...
<Tip>
  Prefer an AI coding agent? See [Use with AI agents](/corbado-observe/overview/use-with-ai-agents) to install the Corbado Observe skill and let your agent instrument the integration for you.
</Tip>
