...
## 4. Track your first event (`loginVisible`)

When your login UI is rendered and visible, send `loginVisible`:
...
- Continue with the [event catalog](/corbado-observe/tracking/events) to instrument the full auth flow.
