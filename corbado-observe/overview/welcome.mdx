...
| --- | --- | --- | --- |
| **[Autocapture](/corbado-observe/get-started/autocapture)** *(fully managed)* | Web | One line of code | Corbado prepares the script, maps your journey from signals your frontend already emits and keeps the tracking current after your releases. No code changes. |
| **[Data layer](/corbado-observe/get-started/data-layer)** *(recommended from source)* | Web | Hours | Your app pushes a few semantic events into an in-page buffer; one central mapping turns them into Observe events and can be updated without an app release. |
| **[Native SDKs](/corbado-observe/get-started/native)** *(iOS and Android)* | iOS, Android | Hooks in your screens plus one adapter module | The SDK captures system evidence on its own, your screens forward a few facts through typed hooks, one module in your app holds the mapping. |
| **[Custom events](/corbado-observe/get-started/custom-events)** | Web | 1 to 3 days | Emit explicit events yourself when you deliberately want hand-written tracker calls. |
