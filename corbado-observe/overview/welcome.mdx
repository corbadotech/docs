...
| **[Custom events](/corbado-observe/get-started/custom-events)** | Web, iOS, Android | Emit explicit events where you need guaranteed semantics, and on native platforms where Autocapture cannot run. |
