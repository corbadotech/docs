...
| **[Custom events](/corbado-observe/get-started/custom-events)** | Web, iOS, Android | 1 to 3 days | Emit explicit events yourself, on native platforms where the browser techniques cannot run, or when you deliberately want hand-written tracker calls. |
