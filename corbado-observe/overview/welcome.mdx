...
| --- | --- | --- | --- |
| **[Autocapture](/corbado-observe/get-started/autocapture)** *(no app changes)* | Web | One line of code | Corbado prepares the script and maps your journey from signals your frontend already emits. |
