...
| **[Custom events](/corbado-observe/get-started/custom-events)** | Web, iOS, Android | 1 to 3 days | Emit explicit events where you need precision tracking, and on native platforms where the browser techniques cannot run. |
