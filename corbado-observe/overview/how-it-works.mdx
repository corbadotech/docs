...
The three [integration paths](/corbado-observe/overview/integration-paths) differ only in step 1. From step 2 onwards they run through the same pipeline.
...
<Steps>
  <Step title="Capture">
    [Autocapture](/corbado-observe/get-started/autocapture) observes what your web frontend already does. The [data layer](/corbado-observe/get-started/data-layer) takes a few semantic events your web app pushes and maps them centrally. [Custom events](/corbado-observe/get-started/custom-events) are events you emit yourself, from the web, iOS or Android SDK.
  </Step>
  <Step title="Send">
...
Observe complements these rather than replacing them. It is deliberately narrow: the client side of authentication, modeled properly. For a category-by-category comparison, see [Which tool reports the real authentication success rate?](https://www.corbado.com/blog/authentication-success-rate-analytics-vendors)
