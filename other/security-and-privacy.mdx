...
2. Reach out via [Slack](https://join.slack.com/t/corbado/shared\_invite/zt-1b7867yz8-V\~Xr\~ngmSGbt7IA\~g16ZsQ) or [contact@corbado.com](mailto:contact@corbado.com) to get further insights or to request a rate limit increase.
