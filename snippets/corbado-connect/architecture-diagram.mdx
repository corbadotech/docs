...
export const ArchitectureDiagram = () => {
  ...
  const areas = [
    ...
    },
    {
        ...
        text: "Actions are custom logic scripts written in JavaScript or TypeScript that execute at specific points within the Corbado Connect journey. They act as hooks, allowing you to deeply customize and extend Corbado Connect's functionality to fit your specific needs. For more details, please refer to our section on <a href=\"/corbado-connect-new/architecture/actions\">Corbado Actions</a>.",
    },
  ];
