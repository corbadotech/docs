...
export const ArchitectureDiagram = () => {
  ...
  const areas = [
    ...
    },
    {
        ...
        rect: { top: '12%', left: '22%', width: '5%', height: '5%' },
        text: "The Corbado Environment is completely isolated from the customer's environment. Corbado Connect can be operated in Corbado's public cloud (shared AWS instance) or private cloud (dedicated AWS instance), depending on regulatory and compliance requirements.",
    },
    {
        id: '10',
    ...
    },
    {
        ...
        rect: { top: '12%', left: '22%', width: '5%', height: '5%' },
        text: "Corbado Actions are small scripts written in JavaScript or TypeScript that allow customization of the passkey flow and execution of specific actions. These actions can vary widely, but they will most likely interact with the customer backend.",
    },
  ];
