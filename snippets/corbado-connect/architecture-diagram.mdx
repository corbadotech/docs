  ...
  const areas = [
    {
        ...
        rect: { top: '6%', left: '17%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '11%', left: '22%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '15.4%', left: '18.5%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '20%', left: '25.1%', width: '4%', height: '4%' },
        text: "The user sign-up flow enables your users to sign-up at your application and needs to be extended with <strong>Corbado Connect</strong> to enable passkey creation. Please refer to our <a href=\"/corbado-connect-new/flows/user-sign-up\">user sign-up</a> documentation.",
    },
    {
        id: '5',
        title: 'User login flow',
        rect: { top: '20%', left: '53.7%', width: '4%', height: '4%' },
        text: "The user login flow enables your users to login at your application and needs to be extended with <strong>Corbado Connect</strong> to enable passkey login. Please refer to our <a href=\"/corbado-connect-new/flows/login\">user login</a> documentation.",
    },
    {
        id: '6',
        title: 'Passkey UI',
        rect: { top: '47.1%', left: '25.1%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '78.3%', left: '41.2%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '86.9%', left: '50.5%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '6%', left: '88.5%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '19%', left: '92%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '49.5%', left: '91.5%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '69.5%', left: '79.5%', width: '4%', height: '4%' },
    ...
    },
    {
        ...
        rect: { top: '69.5%', left: '93%', width: '4%', height: '4%' },
    ...
    },
    {
        id: '14',
        title: 'Passkey UI',
        rect: { top: '47.1%', left: '53.7%', width: '4%', height: '4%' },
        text: "The Passkey UI includes all components related to the user interface and frontend logic required for creating and using passkeys. For web applications, you can use our pre-built <a href=\"/corbado-connect-new/ui-components/overview\">Corbado UI components</a>, while for native apps, our Corbado iOS & Android SDKs are available to fully implement the passkey UI. The passkey UI communicates with the Corbado Frontend API to fulfill its function.",
    },
  ];
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', border: '2px solid #eee', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
      <div style={{ position: 'relative', display: 'block' }}>
        <img src={imageSrc} alt="Architecture Diagram" style={{ display: 'block', width: '100%', margin: 0 }} />
        {areas.map(area => (
          <div
            key={area.id}
            title={area.title}
