                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            cursor: imageLoaded ? (
                                isDragging ? 'grabbing' : 
                                (imageDimensions.width * scale > (containerRef.current?.offsetWidth || 0) || 
                                 imageDimensions.height * scale > (containerRef.current?.offsetHeight || 0)) ? 'grab' : 'default'
                            ) : 'wait',
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'center',
                    ...
                    >
                        ...
                        {(imageDimensions.width * scale > (containerRef.current?.offsetWidth || 0) || 
                          imageDimensions.height * scale > (containerRef.current?.offsetHeight || 0)) && (
                            <div 
                                className="drag-hint"
                                style={{ 
                                    position: 'absolute', 
                        ...
                        >
                            <img 
                                ...
                                onLoad={(e) => {
                                    ...
                                    if (containerRef.current) {
                                        ...
                                        if (isMobile) {
                                            ...
                                            newWidth = imgWidth < availableWidth ? imgWidth + 'px' : '100%';
                                            newHeight = imgHeight < availableHeight ? imgHeight + 'px' : '100%';
                                        }
                                ...
                                style={{
                                    ...
                                    maxHeight: window.innerWidth <= 768 ? 'none' : '100%',
