            ...
            {showLightbox && (
                ...
                >
                    ...
                    >
                        ...
                        <div style={{ position: 'absolute', right: '20px', bottom: '20px', zIndex: 1000000, backgroundColor: 'rgba(36, 36, 36, 0.76)', padding: '10px', borderRadius: '15px', border: '1px solid rgba(255, 255, 255, 0.3)', pointerEvents: 'none'  }}>
