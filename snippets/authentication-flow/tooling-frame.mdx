                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                onMouseEnter={(e) => scale < maxScale && (e.target.style.background = 'rgba(36, 36, 36, 0.9)')}
                                onMouseLeave={(e) => e.target.style.background = 'rgba(36, 36, 36, 0.76)'}
                            >
                                +
                            </button>
                            <button
                                ...
                                onMouseEnter={(e) => scale > minScale && (e.target.style.background = 'rgba(36, 36, 36, 0.9)')}
                                onMouseLeave={(e) => e.target.style.background = 'rgba(36, 36, 36, 0.76)'}
                            >
                                −
                            </button>
                            <button
                                ...
                                onMouseEnter={(e) => (scale !== 1 || position.x !== 0 || position.y !== 0) && (e.target.style.background = 'rgba(36, 36, 36, 0.9)')}
                                onMouseLeave={(e) => e.target.style.background = 'rgba(36, 36, 36, 0.76)'}
                            >
                                ⟲
                            </button>
