...
<CardGroup cols={3}>
    <Card title='Next.js' href='/corbado-complete/fullstack-integration/next-js' icon={
  ...
  <Card title='Svelte' href='/corbado-complete/fullstack-integration/svelte' icon={
    ...
    <Card title='Nuxt.js' href='/corbado-complete/fullstack-integration/nuxt-js' icon={
