...
> **Important:** This component is designed for users who are already logged in. You must generate secure ConnectTokens (see [here](/corbado-connect-new/ui-components/overview#3-connecttokens-ctk)) on your backend for listing, appending, and deleting passkeys to validate that the user session is legitimate.
