...
- [Gradual Rollout](/corbado-connect-new/features/gradual-rollout) allows you to control which users have access to passkey management features. For example, the ability to add new passkeys from the settings page can be enabled for a small percentage of users initially and then progressively rolled out to your entire user base.
