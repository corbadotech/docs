...
## Public Cloud (Shared AWS Instance)
...
The dedicated AWS instance can be managed either by you or by Corbado. If Corbado manages it, we will provide break-glass user access for emergency situations.
