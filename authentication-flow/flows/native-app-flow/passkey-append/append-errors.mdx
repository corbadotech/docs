...
<Tab title="iOS">
    <ToolingFrame 
        imageURL="/images/authentication-flow/native-app/append-errorstates-ios-native.png"
        caption="Native: iOS passkey append error states"
        imageName="append-errorstates-ios-native.png"
    />
</Tab>

  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/native-app/append-errorstates-android-native.png"
        caption="Native: Android passkey append error states"
        imageName="append-errorstates-android-native.png"
    />
  </Tab>
</Tabs>
