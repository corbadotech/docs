---
title: "In-App Nudge: After Unlock"
...
<Steps>
    ...
    <Step title="In-App Nudge appears immediately after unlock">
        ...
        - This approach maximizes visibility but results in two consecutive biometric prompts (unlock + passkey creation). Some developers prefer the [After CTA](/authentication-flow/flows/native-app-flow/passkey-append/in-app-nudge-after-cta) approach to avoid this, though immediate triggering ensures higher exposure.
    </Step>
