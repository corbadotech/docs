...
![Web Component Flow Existing Users](/images/frontend-integration/ui-components/web-component/existing-app/web-component-existing-users.webp)

## Setup webhooks&#x20;

<Warning>
Webhooks / Corbado CLI are only required if you connect your existing user base. If you create a new application without existing users, you do not need webhooks / Corbado CLI. In this case, please do the integration at [New application (no existing users)](/frontend-integration/ui-components/web-component-previous-version/new-application-no-existing-users).
</Warning>
...
<Info>
Please have a look at [webhooks](/products/corbado-connect/connect-via-webhooks) for more details.
</Info>
...
![Webcomponent authentication flow](/images/frontend-integration/ui-components/web-component/existing-app/web-component-passwords-existing-users.webp)
