...
| endpoint                | This should be your [Frontend API](/backend-integration/corbado-api-structure/frontend-api).                                                                                                                                                                           | `https://<project ID>.frontendapi.corbado.io`    |
...
1. Corbado sends an [AJAX](https://www.w3schools.com/js/js_ajax_intro.asp) call to your [Frontend API](/backend-integration/corbado-api-structure/frontend-api).
