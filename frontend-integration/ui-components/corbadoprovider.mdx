...
| frontendApiUrl        | string                       | Please set this value when you go live to your defined [CNAME](/helpful-guides/url-overview#5-cname). By default it is automatically set to your [Frontend API](/backend-integration/corbado-api-structure/frontend-api) URL.                         |
