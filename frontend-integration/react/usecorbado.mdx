...
-   [PasskeyList UI](/frontend-integration/ui-components/passkeylist) already makes use of `getPasskeys`, `appendPasskey` and `deletePasskey` to provide a passkey management interface.
