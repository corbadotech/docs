...
The easiest way for achieving the seamless transition without defining own logic is to use [Corbado Connect via webhooks](/products/corbado-connect/connect-via-webhooks).
