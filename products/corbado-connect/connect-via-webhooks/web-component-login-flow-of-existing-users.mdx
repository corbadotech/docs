...
![Complete login flow](/images/products/corbado-connect/connect-via-webhooks/webcomponent-login-flow/webcomponent-login-flow.webp)

## Prerequistes

For the following process to work and be displayed, you must set up webhooks first as described [here](/products/corbado-connect/connect-via-webhooks/webhooks).
