...
1. [Corbado webhooks actions](#1-webhooks-actions)
...
<Note>
 Already have webhooks in place? Find out how test them [here](/products/corbado-connect/connect-via-webhooks/webhooks/webhooks-testing).
</Note>
...
| [events](/products/corbado-connect/connect-via-webhooks/webhooks/action-events) | This action triggers webhooks for specific user-related events such as creation, deletion, and updates.|
