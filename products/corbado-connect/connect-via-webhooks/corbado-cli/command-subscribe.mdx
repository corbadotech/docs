...
Currently the `subscribe` command is the most important one in the Corbado CLI. It lets you subscribe to our tunnel server to receive [webhook ](/helpful-guides/webhooks)requests locally.&#x20;

To fully understand the `subscribe` command you should get familiar with our [webhooks ](/helpful-guides/webhooks)first.
