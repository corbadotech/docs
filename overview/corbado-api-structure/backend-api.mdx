...
To call our Backend API, you need the Backend API URL, the Corbado project ID and the API secret (both are used for HTTP basic authentication) which you can find in the [developer panel](https://app.corbado.com/app/settings/general/project-info).
...
<Card href="https://apireference.cloud.corbado.io/backendapi-v1/">
