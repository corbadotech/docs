...
2. [Login identifiers and fallbacks](/overview/configuration/user-flow-configuration#2-login-identifiers-and-fallbacks): Configure the required user information for sign-up and login, as well as the authentication fallback options.
