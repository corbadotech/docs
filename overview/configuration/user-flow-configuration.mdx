...
- Verifiable by [one-time passcode](/overview/customization/user-flow-configuration#3-4-1-one-time-passcode) or [email magic link](/overview/customization/user-flow-configuration#3-4-2-magic-link) (email address and phone number)
...
<table><thead><tr><th width="150">Login Identifier</th><th>[Allow Login](/overview/customization/user-flow-configuration#3-1-allow-login)</th><th>[Fallback](/overview/customization/user-flow-configuration#3-2-fallback)</th><th>[Verification stage](/overview/customization/user-flow-configuration#3-3-verification-stage)</th><th>[Verification methods](/overview/customization/user-flow-configuration#3-4-verification-methods)</th></tr></thead><tbody><tr><td>Email address</td><td>Yes</td><td>Yes</td><td>none<br/>At sign-up<br/>Before first login</td><td>One-time passcode<br/>Email magic link</td></tr><tr><td>Phone number</td><td>Yes</td><td>Yes</td><td>None<br/>At sign-up<br/>Before first login</td><td>One-time passcode</td></tr><tr><td>Username</td><td>Yes</td><td>No</td><td>None</td><td>None</td></tr></tbody></table>
