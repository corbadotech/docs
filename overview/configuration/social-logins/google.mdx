...
1. In the [Corbado developer panel](https://app.corbado.com/signin#register), navigate to **Settings > User Interface > Login**. Activate the Google option and ensure "Use custom credentials" is selected. Copy the Authorized Redirect URI for later use.
