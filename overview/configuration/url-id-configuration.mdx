...
* [Relying party ID](#1-relying-party-id)
* [Native app settings ](#2-native-app-settings)(only for native Android or iOS apps)
* [Authorized origins](#3-authorized-origins) (for production deployments)
* [CNAME](#4-cname) (for production deployments)
