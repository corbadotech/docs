...
Besides defining the [technical passkey settings in the previous section](passkey-configuration.md), we now take a look how the user flow and user experience can be adapted. These settings directly impact the user journey during sign-up and login.
