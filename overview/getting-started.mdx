...
<Steps>
    <Step title="Sign up to Corbado">
        ...
        After successful account creation, the Corbado developer panel opens, you might fill a short survey and you can
    ...
    <Step title="Next steps">
        ...
        - **[Docs](#framework-specific-integration-guides)**: Dive into quick guides found in our documentation.
    </Step>
</Steps>
