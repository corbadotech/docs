...
<a href="https://www.corbado.com/blog/webauthn-relying-party-id-rpid-passkeys">
<Frame className="flex gap-x-4 items-center">
<img src="/images/corbado.png" width={32} /> <p>WebAuthn Relying Party ID (rpID) & Passkeys: Domains & Native Apps</p>
</Frame>
</a>