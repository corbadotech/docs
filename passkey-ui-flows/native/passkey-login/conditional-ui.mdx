...
<Tab title="iOS">
  ...
  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/native-app/autosuggested-passkeys-android-native.webp"
        caption="Native: Android Conditional UI flow"
        imageName="autosuggested-passkeys-android-native.webp"
    />
  </Tab>
</Tabs>
