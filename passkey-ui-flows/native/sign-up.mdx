...
Users registering across native apps follow the described journey:
...
<Tab title="iOS">
    <ToolingFrame 
        imageURL="/images/authentication-flow/native-app/sign-up-flow-ios-native.webp"
        caption="iOS sign-up flow"
        imageName="sign-up-flow-ios-native.webp"
    />
</Tab>

  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/native-app/sign-up-flow-android-native.webp"
        caption="Android sign-up flow"
        imageName="sign-up-flow-android-native.webp"
    />
  </Tab>
</Tabs>
