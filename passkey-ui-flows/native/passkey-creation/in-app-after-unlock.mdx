...
<Steps>
    ...
    <Step title="In-App Nudge appears immediately after unlock">
        ...
        - This approach maximizes visibility but results in two consecutive biometric prompts (unlock + passkey creation). Some developers prefer the [After CTA](/passkey-ui-flows/native/post-login-nudges/in-app-after-cta) approach to avoid this, though immediate triggering ensures higher exposure.
    </Step>
