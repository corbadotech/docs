...
<Tabs>
  <Tab title="macOS">
    <ToolingFrame 
        ...
        caption="macOS general login error states"
...
<Tab title="Windows">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/desktop/passkey-login-errorstates-windows.webp"
        caption="Windows general login error states"
        imageName="passkey-login-errorstates-windows.webp"
    />
</Tab>
<Tab title="iOS">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/mobile/passkey-login-errorstates-ios.webp"
        caption="iOS general login error states"
        imageName="passkey-login-errorstates-ios.webp"
    />
</Tab>

  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/web-app/mobile/passkey-login-errorstates-android.webp"
        caption="Android general login error states"
        imageName="passkey-login-errorstates-android.webp"
    />
  </Tab>
</Tabs>

<Steps>
    <Step title="Error: no identifier / unrecognized identifier">
...
<Tab title="Windows">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/desktop/passkey-errorstates-windows.webp"
        caption="Windows passkey login error states"
        imageName="passkey-errorstates-windows.webp"
    />
</Tab>
<Tab title="iOS">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/mobile/passkey-errorstates-ios.webp"
        caption="iOS passkey login error states"
        imageName="passkey-errorstates-ios.webp"
    />
</Tab>

  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/web-app/mobile/passkey-errorstates-android.webp"
        caption="Android passkey login error states"
        imageName="passkey-errorstates-android.webp"
    />
  </Tab>
</Tabs>
