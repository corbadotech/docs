...
description: "Immediate mode can show the passkey account chooser menu immediately after a sign-in-relevant user gesture and stays silent when no passkey is available."
---
