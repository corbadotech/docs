...
<Tab title="Windows">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/desktop/one-tap-windows.webp"
        caption="Windows one-tap passkey flow"
        imageName="one-tap-windows.webp"
    />
</Tab>

<Tab title="iOS">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/mobile/one-tap-ios.webp"
        caption="iOS one-tap passkey flow"
        imageName="one-tap-ios.webp"
    />
</Tab>

  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/web-app/mobile/one-tap-android.webp"
        caption="Android one-tap passkey flow"
        imageName="one-tap-android.webp"
    />
  </Tab>
</Tabs>
