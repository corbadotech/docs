...
<Tab title="Windows">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/desktop/append-after-error-windows.webp"
        caption="Windows passkey append after error"
        imageName="append-after-error-windows.webp"
    />
</Tab>
<Tab title="iOS">
    <ToolingFrame
        imageURL="/images/authentication-flow/web-app/mobile/append-after-error-ios.webp"
        caption="iOS passkey append after error"
        imageName="append-after-error-ios.webp"
    />
</Tab>

  <Tab title="Android">
    <ToolingFrame 
        imageURL="/images/authentication-flow/web-app/mobile/append-after-error-android.webp"
        caption="Android passkey append after error"
        imageName="append-after-error-android.webp"
    />
  </Tab>
</Tabs>
