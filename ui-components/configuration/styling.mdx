...
You can pass the theme to the [CorbadoProvider](/ui-components/corbadoprovider) `theme` setting. If no setting is passed, the default theme is used.
...
Finally, configure the [CorbadoProvider](/ui-components/configuration/corbadoprovider) component to use the theme.
