...
- define okta version (they have multiple products)
-
...
**Okta** offers multiple authentication solutions that have evolved over time (**Corbado Connect** does not support all of them):

- **Okta Identity Engine**: Supported by **Corbado Connect** (requires custom domain and hosted widget)
- **Okta CIC/Auth0**: Supported by **Corbado Connect** (Auth0 was acquired by Okta in 2021 and is now part of Okta CIC)
- **Okta Classic**: Not supported by **Corbado Connect**

If you need more information about the different Okta products, read our [blog article](https://www.corbado.com/blog/okta-passkeys-analysis) or [contact us](TODO).
