...
- ✅ **Okta Identity Engine**: Supported (requires custom domain and hosted widget)
- ✅ **Okta CIC/Auth0**: Supported (Auth0 was acquired by Okta and is now part of Okta CIC)
- ❌ **Okta Classic**: Not supported

If you need more information about the different **Okta** solutions, read our [blog article](https://www.corbado.com/blog/okta-passkeys-analysis) or [contact us](TODO).
