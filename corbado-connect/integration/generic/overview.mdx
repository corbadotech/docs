...
Here is a visual overview of the recommended user journey, outlining each step where you need to implement **Corbado Connect** using our [UI components](/corbado-connect/web-ui-components):
