...
Here is a visual overview of the recommended user journey, outlining each step where you need to implement **Corbado Connect** using our [Corbado Web UI Components](/corbado-connect/web-ui-components):
