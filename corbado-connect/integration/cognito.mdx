...
sequenceDiagram
    ...
    ExampleBackend->>+BAPI: POST /v2/connectToken
...
<Info>
For a detailed explanation of all available props for this component, please see the [CorbadoConnectPasskeyList component documentation](/corbado-connect/ui-components/corbadoconnectpasskeylist).
</Info>
