...
Corbado provides comprehensive audit logging capabilities designed to meet your organization's compliance and security requirements. Our audit logging system captures and securely stores all critical events across your authentication infrastructure, providing complete visibility into user activities, administrative actions, and system operations.
...
- **Compliance-Ready**: Designed to align with major compliance frameworks including SOX, HIPAA, GDPR, PCI DSS, ISO 27001, and SOC 2
...
- **Long-Term Retention**: Audit logs are retained for up to 10 years, depending on your plan and contractual requirements
- **Real-Time Streaming**: Stream audit events to external systems like SIEM platforms for real-time monitoring and analysis
...
Corbado captures audit log events from different operational areas to provide comprehensive visibility into your authentication infrastructure.

The audit log covers the following event categories:

- **Authentication Events**: User login attempts, passkey operations, and other authentication-related activities
- **User Management Events**: User creation, profile updates, account status changes, and permission modifications  
- **Administrative Events**: Configuration changes, [gradual rollout](/corbado-connect/features/gradual-rollout) rule updates, and system administration activities
