...
description: "Comprehensive audit logging with tamper-proof storage, real-time streaming to external systems, and compliance-ready event tracking for authentication, user management, and administrative activities."
...
Corbado provides comprehensive audit logging capabilities designed to meet your organization's compliance and accountability requirements. Our audit logging system captures and securely stores all critical events across the authentication infrastructure, providing complete visibility into user activities, administrative actions, and system operations.

<Note>
    For security-related events, refer to our dedicated page explaining our [security log](/corbado-connect/security-compliance/security-log).
</Note>
...
This audit logging system provides the foundation for maintaining oversight and meeting regulatory requirements.
