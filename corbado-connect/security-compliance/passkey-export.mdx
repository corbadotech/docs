...
Corbado Connect provides multiple storage deployment models to align with your organization's data governance, compliance requirements, and operational preferences:

#### **Standard Enterprise: Corbado-Managed Dedicated Storage**

The standard Enterprise implementation provides each customer with a dedicated S3 bucket within their isolated Corbado environment. This approach delivers enterprise-grade security while minimizing operational overhead for your teams.
...
#### **Advanced Enterprise: Customer-Controlled Storage Infrastructure**

For organizations with specific data sovereignty or compliance requirements, passkey exports can be configured to deliver directly to your own AWS S3 storage infrastructure. This approach ensures authentication data resides entirely within your organization's control while maintaining automated export delivery from Corbado's dedicated enterprise environment.
...
#### **Enterprise Plus Addon: Custom Storage Solutions**

For Enterprise Plus tier customers with specialized requirements, Corbado offers an addon that enables additional storage customization options beyond standard cross-account S3 configurations:
...
<Warning>
Enterprise Passkey Export is available exclusively for Enterprise tier customers. Standard Enterprise contracts include Corbado-managed dedicated storage with Management Console access. Advanced configurations with customer-controlled S3 buckets are available for Enterprise customers with specific compliance requirements. Custom storage solutions beyond AWS S3 are available as an addon for Enterprise Plus agreements.
</Warning>
