...
<Frame caption="Amazon HTTP endpoint configuration">
![Amazon HTTP endpoint configuration](/images/corbado-connect/passkey-export-configuration-http-endpoint.webp)
</Frame>
