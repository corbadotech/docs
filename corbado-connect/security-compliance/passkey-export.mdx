---
title: "Automatic Passkey Export to S3"
description: "Learn how Corbado Connect automatically exports your passkeys to S3 daily as CSV files. Download exports from the Management Console and import them into your own authentication system for seamless migration and data portability."
...
In addition to our existing backup and disaster recovery capabilities that are part of our enterprise solution, Corbado Connect addresses continuity requirements and vendor lock-in provisions of regulated entities by providing automatic passkey export functionality. This ensures your authentication data is secure, portable, and fully under your control. Our system automatically creates daily exports of all passkeys stored in your project, saving them as compressed CSV files in Amazon S3, enabling seamless portability and export of passkeys for compliance and business continuity purposes.

### 1.1. Key Features

- **Automated Daily Exports**: Passkeys are automatically exported once per day as gzipped CSV files
- **Secure Storage**: Exports are stored in Amazon S3 with enterprise-grade security
- **Easy Access**: Download export files directly from the Corbado Management Console
