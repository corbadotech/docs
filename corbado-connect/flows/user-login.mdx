...
Explore the following integrations to see how the user login flow is implemented, complete with additional documentation and sequence charts:

- [Generic](/corbado-connect/integration/generic#user-login)
- [Amazon Cognito](/corbado-connect/integration/cognito#user-login)