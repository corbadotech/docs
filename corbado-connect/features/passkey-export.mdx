...
In addition to our existing backup and disaster recovery capabilities that are part of our enterprise solution, Corbado Connect addresses continuity requirements and vendor lock-in provisions of regulated entities by providing automatic passkey backup functionality. This ensures your authentication data is secure, portable, and fully under your control. Our system automatically creates daily backups of all passkeys stored in your project, saving them as compressed CSV files in Amazon S3, enabling seamless portability and backup of passkeys for compliance and business continuity purposes.
