...
- For **iOS** applications, this involves configuring an **AASA (Apple App Site Association)** file
...
3. The hosting configuration for your **AASA** file
...
- Explain AASA file
- Show link to example file with addon that this is explained in detailed in the hosting section below (link to this section) => https://pro-1.frontendapi.cloud.corbado.io/.well-known/apple-app-site-association
