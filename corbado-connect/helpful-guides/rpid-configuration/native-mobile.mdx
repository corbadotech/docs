...
<Note>
Before testing passkeys on physical **Android** devices, ensure you have the latest version of Google Play Services installed, as it provides the passkey functionality.
</Note>
...
<Info>
`com.example.app` is the **Package Name** and the SHA-256 string is your application's **Certificate Fingerprint**, see [below](#3-2-package-name-and-certificate-fingerprint) to learn more about these identifiers.
</Info>
...
3. When your **Android** application attempts to use passkeys:
   ...
   - Verifies that your application's **Package Name** and **Certificate Fingerprint** are listed in the file
4. If verification succeeds, your **Android** application is authorized to use passkeys for the specified **RPID**

<Warning>
**Android** caches the **Asset Links** file. During development, you can force a refresh by clearing your application's data or reinstalling it.
</Warning>

### 3.2. Package Name and Certificate Fingerprint
