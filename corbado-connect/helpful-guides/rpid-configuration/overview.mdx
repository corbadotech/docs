...
- Link from Developer Panel RPID Setting and Integration guides to this page
...
You can configure the **RPID** in the [Corbado developer panel](https://app.corbado.com/settings/general?tab=URLs). Review the following pages to understand how **RPID** validation functions and what key considerations apply to your application type:
