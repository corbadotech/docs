...
When configuring your **RPID** in the [Corbado developer panel](https://app.corbado.com/settings/general?tab=URLs), we recommend using your root domain `example.com`. Only use a subdomain as **RPID** if you specifically need to restrict passkey usage to that subdomain.
