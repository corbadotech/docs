...
- Explain best practice to use root domain because most flexible for the future (if you have not planned different projects / passkey spaces on different sub domains)
