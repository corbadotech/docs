...
As a developer, it might be helpful to use the [Google Chrome WebAuthn emulator](/corbado-connect/helpful-guides/google-chrome-virtual-authenticator). It allows you to test the WebAuthn API (the base for passkeys) with a virtual authenticator if your hardware does not offer any biometric scanners:
...
-   [Relying party ID](/corbado-connect/helpful-guides/passkeys/relying-party-id)
-   [Passkeys in web apps](/corbado-connect/helpful-guides/passkeys/passkeys-in-web-apps)
-   [Passkeys in native apps](/corbado-connect/helpful-guides/passkeys/passkeys-in-native-apps)
-   [Fallback options](/corbado-connect/helpful-guides/passkeys/fallback-options)
