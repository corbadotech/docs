...
description: "Learn all about Cross-Origin Resource Sharing (CORS)"
---
...
In the context of Corbado's solution, we utilize CORS to securely enable interaction between our service and your web application. We set this up by defining the [authorized origins](./url-overview#1-authorized-origin) (your application's domain) in our developer panel. The [authorized origins](./url-overview#1-authorized-origin) are essentially the list of URLs of your web applications where our login web component can be embedded securely.
