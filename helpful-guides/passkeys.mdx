...
As a developer, it might be helpful to use the [Google Chrome WebAuthn emulator](/helpful-/google-chrome-virtual-authenticator). It allows you to test the WebAuthn API (the base for passkeys) with a virtual authenticator if your hardware does not offer any biometric scanners:
